            ...
            <div class="element-wrapper">
                <div class="element-box">
                    ...
                    <div class="form-buttons-w">
                        <a href="{{route('admin.ask.create')}}" class="btn btn-primary create-submit" ><label>+</label> إضافة</a>
                    </div>
                            ...
                            @foreach($rows as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.ask.show',$row->id)}}"><i class="os-icon os-icon-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
