...
class Setting extends Model
{
    ...
    protected $fillable = ['about','licence','privacy','socials','contacts','purchasing_power_text',
        'purchasing_power_ratio','finish_papers','owner_tax_ratio','auction_increasing_period','app_ratio','add_item_tax','tax_ratio','negotiation_period','bid_pause_period','android_version','ios_version','more_details'];
    protected $casts = [
        'more_details' => 'json',
